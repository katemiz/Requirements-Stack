<section class="section container">
    ...
    <script>
        ...
        window.addEventListener('ConfirmDelete',function(e) {
            ...
            let sa_title = 'Do you really want to delete this project MOC definition?'
    ...
    @switch($action)
        ...
        @case('FORM')
            @include('projects.mocs.lw-mocs-form')
            @break

        @case('VIEW')
            @include('projects.mocs.lw-mocs-view')
            @break

        @case('LIST')
        @default
            @include('projects.mocs.lw-mocs-list')
            @break
