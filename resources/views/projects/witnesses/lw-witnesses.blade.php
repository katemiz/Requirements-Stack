<section class="section container">
    ...
    <script>
        ...
        window.addEventListener('ConfirmDelete',function(e) {
            ...
            let sa_title = 'Do you really want to delete this project witness definition?'
    ...
    @switch($action)
        ...
        @case('FORM')
            @include('projects.witnesses.lw-witnesses-form')
            @break

        @case('VIEW')
            @include('projects.witnesses.lw-witnesses-view')
            @break

        @case('LIST')
        @default
            @include('projects.witnesses.lw-witnesses-list')
            @break
