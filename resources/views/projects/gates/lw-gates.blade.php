<section class="section container">
    ...
    <script>
        ...
        window.addEventListener('ConfirmDelete',function(e) {
            ...
            let sa_title = 'Do you really want to delete this Milestone/Decision Gate?'
    ...
    @switch($action)
        ...
        @case('FORM')
            @include('projects.gates.lw-gates-form')
            @break

        @case('VIEW')
            @include('projects.gates.lw-gates-view')
            @break

        @case('LIST')
        @default
            @include('projects.gates.lw-gates-list')
            @break
