<section class="section container">
    ...
    <script>
        ...
        window.addEventListener('ConfirmModal',function(e) {
            ...
            switch (e.detail.type) {
                ...
                case 'test':
                    sa_title = 'Do you really want to delete this chapter?'
    ...
    @switch($action)
        ...
        @case('FORM')
            @include('projects.chapters.chapters-form')
            @break

        @case('VIEW')
            @include('projects.chapters.chapters-view')
            @break

        @case('LIST')
        @default
            @include('projects.chapters.chapters-list')
            @break
